...
class Client extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        'phone' => $this->phone,
        'mobile' => $this->mobile,
        'date_of_birth' => date('d/m/Y h:i a',strtotime($this->date_of_birth)),
        'date_of_graduation' => date('d/m/Y h:i a',strtotime($this->date_of_graduation)),
        'date_of_aniversary' => date('d/m/Y h:i a',strtotime($this->date_of_aniversary)),
        'gender' => $this->gender,
